package com.zyp.plugin.demo.watcher
...
class ServiceWatcher() : InstallableWatcher {
...
//    checkMainThread()
    ...
    try {
      swapActivityThreadHandlerCallback { mCallback ->
        ...
        Handler.Callback { msg ->
          ...
          if (msg.what == STOP_SERVICE) {
            ...
            Log.i("ZYPP", "activityThreadServices: ${activityThreadServices.size}, ${activityThreadServices.map { it.value }.toTypedArray().contentToString()}")
      ...
      Log.i("ZYPP", "Could not watch destroyed services" )
    }
  }
...
//        )
  ...
  fun swapActivityThreadHandlerCallback(swap: (Handler.Callback?) -> Handler.Callback?) {
    val mHField =
